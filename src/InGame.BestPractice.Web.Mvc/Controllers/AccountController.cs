...
using InGame.BestPractice.Sessions;
using InGame.BestPractice.Web.Models.Account;
using InGame.BestPractice.Web.Views.Shared.Components.TenantChange;

namespace InGame.BestPractice.Web.Controllers
{
    public class AccountController : BestPracticeControllerBase
    {
        ...
        // Kod Github Aspnet.Identity projesinden alıntıdır
        // Url : https://github.com/aspnet/Identity/blob/release/2.1/src/UI/Areas/Identity/Pages/Account/ForgotPassword.cshtml.cs
        [HttpPost]
        [UnitOfWork]
        public async  Task <IActionResult > ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            TempData["CallBack"] = callbackUrl;

            
            /* Dont send email on demo application
        ...
        /*
         *Kod Github Aspnet.Identity projesinden alıntıdır
         *https://github.com/aspnet/Identity/blob/release/2.1/src/UI/Areas/Identity/Pages/Account/ResetPassword.cshtml.cs
         *
         */
        [HttpPost]
        [UnitOfWork]
