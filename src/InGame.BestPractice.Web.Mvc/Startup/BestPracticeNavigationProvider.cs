...
namespace InGame.BestPractice.Web.Startup
{
    ...
    /// </summary>
    public class BestPracticeNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                ).AddItem(new MenuItemDefinition(PageNames.Products,
                    L("Products"), url: "Products", icon: "shopping_cart",
                    requiredPermissionName: PermissionNames.Pages_Products))
                .AddItem(new MenuItemDefinition(PageNames.Categories,
                    L("Categories"), url: "Categories", icon: "control_point",
